...
WP_USER2_PASSWORD=$(cat ${WP_USER2_PASSWORD_FILE:-/run/secrets/wp_user2_password})
...
if [ ! -f "wp-load.php" ]; then
    ...
    ./wp-cli.phar user create user2 user2@inception.42.fr --user_pass="${WP_USER2_PASSWORD}" --role=subscriber --allow-root
fi
